...
class AutoLoanTableViewController: UITableViewController, UIPopoverControllerDelegate {
    ...
    /*var autoLoanTypes = [Dictionary<String, String>()]
    autoLoanTypes.append(["loanId": "used001", "name": "Used Car (Dealer) - 60 months"])*/
    
    var autoLoanTypes = ["Used Car (Dealer) - 60 months", "Used Car (Dealer) - 72 months", "New Car (Dealer) - 60 months", "New Car (Dealer) - 72 months", "Refinance - 60 months", "Refinance - 72 months"]
    var myLoan: Loan?
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = autoLoanTypes[indexPath.row]
